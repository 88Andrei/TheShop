...
require_once './controllers/admin/product_list_controller.php';
...
$router->register('GET', '/admin/product_list', 'ProductListController::productList');
$router->register('POST', '/admin/products', 'ProductController::delete');
